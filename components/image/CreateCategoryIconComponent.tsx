...
import { useUploadCategoryIconMutation } from '@/redux/service/image'; 
...
export default function CreateCategoryIconComponent({
  isOpen,
  onOpenChange,
}: ModalType) {
  const [uploadImage, { data, error }] = useUploadCategoryIconMutation();
...
const CustomInput = ({ field, form, setFieldValue }: any) => {
  ...
  return (
    <div>
      <div className="my-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10 dark:border-gray-50">
